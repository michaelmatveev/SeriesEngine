...
namespace SeriesEngine.ExcelAddIn.Views
{
    public partial class DataBlockProperties : Form, IDataBlockPropertiesView
    {
        ...
        public DataBlockProperties(IList<string> sheets, IModelProvider modelProvider)
        {
        ...
        public CollectionDataBlock DataBlock { get; set; }

        public void ShowIt()
        {
            textBoxName.DataBindings.Add(nameof(textBoxName.Text), DataBlock, nameof(DataBlock.Name));
            comboBoxSheet.DataBindings.Add(nameof(comboBoxInterval.SelectedItem), DataBlock, nameof(DataBlock.Sheet));
            textBoxCell.DataBindings.Add(nameof(textBoxCell.Text), DataBlock, nameof(DataBlock.Cell));
